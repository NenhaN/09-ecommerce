                    ...
                    <div class="collapse navbar-collapse" id="navbarsExample07">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <?php if(connect()): ?>
                                ...
                                <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="inscription.php">Votre compte</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li><a class="dropdown-item" href="admin/commandes.php">Gestion commande</a></li>
                                <li><a class="dropdown-item" href="admin/users.php">Gestion users</a></li>
                                </ul>
                            </li>
                            <?php endif; ?>
                        ...
                        <!-- Exo : afficher dans la nav la phrase "Hello ! nom prénom" 
                        en passant par le fichier de session de l'utilisateur
                        ($_SESSION)-->
                        ...
                        <a href="connexion.php?action=deconnexion" class="btn btn-success ms-3">Déconnexion</a>
